...
c _______________________________________________________________________
      external bforce
      parameter (nmax=100000,nbmax=4,ngmax=16,nmaxut=250)
...
c between al-al, al-fe, fe-fe
 ...
 100  ihi=i-1
      ...
      temp = outf(1:ihi)//'tV2'                              
      open(45,file=temp,STATUS= 'UNKNOWN')
...
c write the velocity profile
      ...
      do i = 1,mindex
        if (vn(i) .gt. 0) then
          ...
          write(45,'(7F20.10)')v(i),-H1/2 + i*H1/mindex, vn(i)
        else
           write(45,'(7F20.10)')0.0,-H1/2+i*H1/mindex,0.0
        endif
      enddo
      close(29)
